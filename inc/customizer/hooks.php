...
add_filter( 'storefront_default_footer_heading_color', 			'bs_color_charcoal' );
add_filter( 'storefront_default_button_text_color', 			'bs_color_charcoal' );
add_filter( 'storefront_default_header_background_color', 		'bs_color_charcoal' );
...
add_filter( 'storefront_default_accent_color', 					'bs_color_black' );
add_filter( 'storefront_default_footer_link_color', 			'bs_color_black' );

add_filter( 'storefront_default_text_color', 					'bs_color_english_winter' );
add_filter( 'storefront_default_footer_text_color', 			'bs_color_english_winter' );

add_filter( 'storefront_default_accent_color', 					'bs_color_gold' );
add_filter( 'storefront_default_button_alt_background_color', 	'bs_color_gold' );

add_filter( 'storefront_default_background_color', 				'bs_color_asphalt' );
